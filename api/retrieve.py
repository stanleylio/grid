...
class MeterData(object):
    ...
    Valid variables:
        FREQ,
        AVRMS, AVFRMS, AIRMS, AIFRMS, AWATT, AFWATT, AFVAR, AFTHETA, AFPF, ATHD, ATDD, 
        BVRMS, BVFRMS, BIRMS, BIFRMS, BWATT, BFWATT, BFVAR, BFTHETA, BFPF, BTHD, BTDD,  
        CVRMS, CVFRMS, CIRMS, CIFRMS, CWATT, CFWATT, CFVAR, CFTHETA, CFPF, CTHD, CTDD, 
        TPMON, ts_pic
